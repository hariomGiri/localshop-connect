        ...
        >
          ...
          <div className="relative max-w-md mt-8">
            ...
            <input
              ...
              className="pl-10 pr-4 py-3 w-full rounded-xl border bg-white/90 backdrop-blur-sm focus:ring-2 focus:ring-primary focus:border-primary focus:outline-none shadow-sm transition-all"
            />
